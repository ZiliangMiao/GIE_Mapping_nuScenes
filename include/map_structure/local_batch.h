...
public:
    ...
    {   
        // printf("crd2idx: local_size.x %d, local_size.y %d, local_size.z %d, c.x %d, c.y %d, c.z %d\n", _local_size.x, _local_size.y, _local_size.z, c.x, c.y, c.z);
        // local_size (voxel) meter / voxel_size
